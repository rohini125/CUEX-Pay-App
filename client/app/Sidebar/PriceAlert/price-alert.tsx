...
//   const router = useRouter();
//   const { addNotification } = useNotification(); // ✅ Hook used at top level
...
//       } catch (err) {
//         console.log("Error fetching currencies:", err);
//         addNotification("Error fetching currency list.");
//       }
//     };
...
//       } catch (err) {
//         console.log('Error loading alerts:', err);
//         addNotification("Error loading saved alerts.");
//       }
//     };
...
//       addNotification(`Alert created for ${selectedCurrency} at ₹${alertPrice.toFixed(2)}`);
//     } catch (err) {
//       console.log("Error creating alert:", err);
//       addNotification("Error creating alert.");
//     }
//   };
...
//       addNotification("Alert deleted.");
//     } catch (err) {
//       console.log("Error deleting alert:", err);
//       addNotification("Error deleting alert.");
//     }
//   };
...
//     borderRadius: 6,
//   },
//   adjustBtnText: { color: '#fff', fontSize: 18 },
//   card: {
//     backgroundColor: "#e2f1ff",
//     borderRadius: 12,
//     padding: 16,
